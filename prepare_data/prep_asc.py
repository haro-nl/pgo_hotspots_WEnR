...
holder = []
i = 0
with open(os.path.join(vaatplant_dir, 'vaatplant_all4.csv'), 'w') as f:
    for file in os.listdir(vaatplant_dir):
        if file.endswith('asc') and file.startswith('vaatplant') and os.path.isfile(os.path.join(vaatplant_dir, file)):
            ...
            # holder.append(foo)
            if i == 0:
                f.write('# Deze tabel bevat alle informatie uit alle *.asc bestanden '
                ...
                f.write('# Hans Roelofsen, WEnR BB, 12 Jun 2019 12:27')
