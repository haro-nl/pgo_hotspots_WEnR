...
soorten = ['all', 'vlinder', 'vogel', 'vaatplant']  # one of: vlinder, vaatplant, vogel, all
snl_types = ['HalfnatuurlijkGrasland', 'Heide', 'Bos', 'Moeras', 'OpenDuin']  #'HalfnatuurlijkGrasland', 'OpenDuin', 'Heide', 'Bos', 'Moeras']  # iterable of SNL beheercodes OR  EcosysteemType naam
soort_lijst = ['EcoSysLijst']  # iterable of soortenlijsten: SNL, Bijl1, EcoSysLijst
